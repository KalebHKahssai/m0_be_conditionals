...
puts 4 < 9
#YOU DO: Explain.
# This code asks is 4 less than 9, it will print out true.

books = 3
puts 4 < books
# YOU DO: Explain.
#This code asks is books is greater than or equal to 3, it will print out false.

friends = 6
siblings = 2
puts friends > siblings
# YOU DO: Explain.
# This code asks is friends are greater than to siblings, it will print out true.

attendees = 9
meals = 8
puts attendees != meals
# YOU DO: Explain.
# This code asks is attendees not equal to meals, it will print out true.
...
# ANSWER: Comparison are true and false, the age variable is not a boolean.
